...
public class GroupGRP extends Group {
	...
	public static ItemFileType[] FILE_TYPES = {
		new ItemFileType("Duke Nukem 3D Group", "GRP")
	};
	...
	public GroupGRP() throws InvalidFileTypeException, UnsupportedFileTypeException {
		super(FILE_TYPES[0]);
	}
	
	public GroupGRP(String fileName) throws InvalidFileTypeException, UnsupportedFileTypeException {
		super(fileName, FILE_TYPES[0]);
	}
	
	public GroupGRP(File file) throws InvalidFileTypeException, UnsupportedFileTypeException {
