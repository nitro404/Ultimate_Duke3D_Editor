...
public class GroupSSI extends Group {
	...
	public static GroupFileType[] FILE_TYPES = {
		new GroupFileType("SSI Group Version 1", "SSI"),
		new GroupFileType("SSI Group Version 2", "SSI")
	};
	...
	public GroupSSI() throws InvalidGroupFileTypeException, UnsupportedGroupFileTypeException {
		super(FILE_TYPES[1]);
	...
	public GroupSSI(String fileName) throws InvalidGroupFileTypeException, UnsupportedGroupFileTypeException {
	...
	public GroupSSI(File file) throws InvalidGroupFileTypeException, UnsupportedGroupFileTypeException {
	...
	public boolean setGroupFileType(GroupFileType fileType) {
		if(super.setGroupFileType(fileType)) {
	...
	public static SSIVersion getVersionFromFileType(GroupFileType fileType) {
