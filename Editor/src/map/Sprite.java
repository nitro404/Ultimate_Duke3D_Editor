...
public class Sprite extends TaggedMapComponent implements ItemAttributeChangeListener, Position3DChangeListener, VelocityChangeListener {
	...
	public static final int SIZE = 18 + Position3D.SIZE + SpriteAttributes.SIZE + Velocity.SIZE + TagInformation.SIZE;
	...
	public static Sprite fromJSONObject(JSONObject sprite) throws IllegalArgumentException, JSONException, MalformedItemAttributeException {
		...
		return new Sprite(
			Position3D.fromJSONObject(sprite.getJSONObject(POSITION_ATTRIBUTE_NAME)),
