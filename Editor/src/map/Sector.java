...
public class Sector extends TaggedMapComponent implements PartitionChangeListener {
	...
	public Sector(short firstWallIndex, short numberOfWalls, int ceilingHeight, short ceilingAttributes, short ceilingTileNumber, short ceilingSlope, byte ceilingShade, short ceilingPaletteLookupTableNumber, short ceilingXPanning, short ceilingYPanning, int floorHeight, short floorAttributes, short floorTileNumber, short floorSlope, byte floorShade, short floorPaletteLookupTableNumber, short floorXPanning, short floorYPanning, short visibility, int lowTag, int highTag, short extra, byte[] trailingData) {
	...
	public Sector(short firstWallIndex, short numberOfWalls, int ceilingHeight, short ceilingAttributes, short ceilingTileNumber, short ceilingSlope, byte ceilingShade, short ceilingPaletteLookupTableNumber, short ceilingXPanning, short ceilingYPanning, int floorHeight, short floorAttributes, short floorTileNumber, short floorSlope, byte floorShade, short floorPaletteLookupTableNumber, short floorXPanning, short floorYPanning, short visibility, byte filler, int lowTag, int highTag, short extra, byte[] trailingData) {
	...
	public Sector(short firstWallIndex, short numberOfWalls, Partition ceiling, Partition floor, short visibility, int lowTag, int highTag, short extra) {
		this(firstWallIndex, numberOfWalls, ceiling, floor, visibility, (byte) 0, new TagInformation(lowTag, highTag, extra), null);
	}

	public Sector(short firstWallIndex, short numberOfWalls, Partition ceiling, Partition floor, short visibility, byte filler, int lowTag, int highTag, short extra) {
		this(firstWallIndex, numberOfWalls, ceiling, floor, visibility,filler, new TagInformation(lowTag, highTag, extra), null);
	}

	public Sector(short firstWallIndex, short numberOfWalls, Partition ceiling, Partition floor, short visibility, int lowTag, int highTag, short extra, byte[] trailingData) {
		this(firstWallIndex, numberOfWalls, ceiling, floor, visibility, (byte) 0, new TagInformation(lowTag, highTag, extra), trailingData);
	}

	public Sector(short firstWallIndex, short numberOfWalls, Partition ceiling, Partition floor, short visibility, byte filler, int lowTag, int highTag, short extra, byte[] trailingData) {
